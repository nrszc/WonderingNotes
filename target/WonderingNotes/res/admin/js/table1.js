...
var re;
function getReportComment(pn,that) {
    re=that;
    $.ajax({
        type:"post",
        data:{
    ...
    layui.use('laypage', function(){
        ...
        laypage.render({
            ...
            ,jump: function(obj, first) {
                //obj包含了当前分页的所有参数，比如：
                if(!first) {
                    getReportComment(obj.curr,that);
                }
            }
        });
    });
